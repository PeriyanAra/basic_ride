...
@immutable
class BasicRideColor extends Color implements WidgetStateProperty<Color> {
  const BasicRideColor(
    super.value, {
    Color? light,
    Color? dark,
    Color? hover,
  ...
  bool operator ==(Object other) =>
      other is BasicRideColor &&
      toARGB32() == other.toARGB32() &&
      _light == other._light &&
      _dark == other._dark &&
      _hover == other._hover &&
...
extension BasicRideColorExtensions on BasicRideColor {
  BasicRideColor lerp(BasicRideColor? other, double t) {
    return BasicRideColor(
